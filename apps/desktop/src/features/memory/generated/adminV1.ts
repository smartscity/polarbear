// Generated from polarbear-memory/api/admin-v1.json. Do not add transport secrets here.
export const MEMORY_ADMIN_API_VERSION = "1.1" as const;
...
export type ContextExplainResponse = {
  markdown: string;
